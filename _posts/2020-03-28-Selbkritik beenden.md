...
Selbstdurchsetzung können wir auch nicht abstellen. Wozu sollten wir hier auf dem Planeten herumturnen, wenn wir uns nicht selbst erfahren wollen bzw. können? Bindungsbedürfnisse können wir auch nicht so ohne weiteres abstellen (wobei das im späteren Leben einfacher ist). 
...
Akzeptanz der inneren harten Glaubenssätze sowie der Selbstkritik *als Schutzanteil* in sich selbst (die man nicht einfach “wegmachen” kann, sollte, oder überhaupt will), war bei mir der Anfang der Heilung. 
